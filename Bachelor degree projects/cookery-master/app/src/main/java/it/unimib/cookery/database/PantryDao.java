...
public interface PantryDao {
    ...
    //Relation
    @Transaction
    @Query("SELECT * FROM pantry WHERE pantry.idPantry LIKE :id")
    public List<PantryWithIngredientPantry> pantryWithIngredientPantry(int id);

    //Relation
    @Transaction
    @Query("SELECT * FROM pantry")
    public List<PantryWithIngredientPantry> pantryWithIngredientPantryALL();
}
